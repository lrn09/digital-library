...
public class PersonDAO {
    ...
    public Person showOwnedBook(int id){
        return jdbcTemplate.query("SELECT * FROM Person p, Book b WHERE b.book_id=? AND b.owner_id = p.person_id", new Object[]{id}, new BeanPropertyRowMapper<>(Person.class))
                .stream().findAny().orElse(null);
    }
